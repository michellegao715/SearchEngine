...
public class HTMLCleaner {
	...
	public static String fetchHTML(String url) {
		...
		try {
			URL u = new URL(url);
			String html = HTMLFetcher.fetch(u);
	...
	public static String stripElement(String name, String html) {
		String stripedElementHtml = html.replaceAll("(?is)<" + name
				+ ".*?>.*?</" + name + ".*?>", " ");
		return stripedElementHtml;
	}
	...
	public static String stripTags(String html) {
		String stripedTagsHtml = html.replaceAll("(?s)<.*?>", " ");
		return stripedTagsHtml;
	}
	...
	public static String stripEntities(String html) {
		String stripedEntitiesHtml = html.replaceAll("&.*?;", " ");
		return stripedEntitiesHtml;
	}
}